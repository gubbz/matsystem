   ...
   console.log("typeofvote in addVote: " + typeOfVote);
    ...
    switch(typeOfVote)  {
      case "very_bad":
        ...
        parseInt(this.currentVotes[3]) = currentVote;
